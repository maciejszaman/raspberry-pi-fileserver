...
## [9.0.13](https://github.com/microsoft/fluentui/tree/@fluentui/react-link_v9.0.13)
...
- refactor(Link): use `event.key` for keyboard event ([PR #19639](https://github.com/microsoft/fluentui/pull/19639) by lingfangao@hotmail.com)
...
- Link: Adding missing state management to handle disabledFocusable scenarios. ([PR #18563](https://github.com/microsoft/fluentui/pull/18563) by Humberto.Morimoto@microsoft.com)
